...
from aresis.pipeline.report import render_markdown
from aresis.schemas import Identifier, InputType


def main() -> None:
    p = argparse.ArgumentParser(description="Run an Aresis self-audit scan locally.")
